...
events.set('BOGY (Berufs-Orientierung an Gymnasien) and Praktika', {
   when: [time(4, 2024), time(5, 2024), time(4, 2025),<>{time(1,2026)} (thank you to J. Schubert)</>, time(2, 2026), time(4, 2026), time(5, 2026)],
   where: 'Ulm University',
