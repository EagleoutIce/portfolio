...
export function MyIntro() {
   return <div className="main" style={{ marginBottom: '0em' }}>
      ...
      My work received the <a href="https://www.uni-ulm.de/in/sp/institute/news-detail/article/youngrse-award-at-derse24/" target="_blank" rel="noreferrer">YoungRSE award</a> at the deRSE24, the <a href="https://www.uni-ulm.de/in/sp/institute/news-detail/article/award-for-the-best-masters-degree/" target="_blank" rel="noreferrer">award for the best master's degree</a> in the field of computer science at Ulm University, and the <a href="https://rsecon25.society-rse.org/awards/" target="_blank" rel="noreferrer">Rising Star award</a> at the RSECon25.
