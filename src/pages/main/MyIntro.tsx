...
export function MyIntro() {
   return <div className="main" style={{ marginBottom: '0em' }}>
      ...
      My name is Florian and I am currently working on my PhD at Ulm University (since September 2023). My primary research interests are in the area of Hybrid Program Analysis to support Program Comprehension and Data Scientists, mostly revolving around <a href="github.com/flowr-analysis/flowr/" target="_blank" rel="noreferrer">flowR</a>.
